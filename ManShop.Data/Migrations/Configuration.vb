...
Namespace ManShop.Data.Migrations

    Friend NotInheritable Class Configuration
        Inherits DbMigrationsConfiguration(Of ManShopDbContext)
        Public Sub New()
            AutomaticMigrationsEnabled = True
        End Sub

        Protected Overrides Sub Seed(ByVal context As ManShopDbContext)
    ...
    .FullName = "Technology Education"}
        ...
        End Sub
        Private Sub CreateProductCategorySample(ByVal context As ManShopDbContext)
    ...
    .Status = True}
        ...
        Private Sub CreateContactDetail(ByVal context As ManShopDbContext)
            If context.ContactDetails.Count() = 0 Then
                Try
                    Dim contactDetail = New ContactDetail() With {.Name = "Shop thời trang Man", .Address = "Ngõ 77 Xuân La", .Email = "tedu@gmail.com", .Lat = 21.0633645, .Lng = 105.8053274, .Phone = "095423233", .Website = "http://tedu.com.vn", .Other = "", .Status = True}
